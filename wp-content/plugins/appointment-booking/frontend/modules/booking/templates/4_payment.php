...
<?php if (get_option('ab_settings_coupons')): ?>
    <div class="ab-row-fluid ab-info-text-coupon"><?php _e( $info_text_coupon, 'ab' ) ?></div>
    <!-- <div class="ab-row-fluid ab-list">
        <div class="ab-formGroup ab-full ab-lastGroup">
            <span style="display: inline-block;"><?php _e( get_option( 'ab_appearance_text_label_coupon' ), 'ab' ) ?></span>
